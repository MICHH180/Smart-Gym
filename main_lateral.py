...
sesion_id = registro.iniciar_sesion("elevacion_lateral")
 
cap = CamaraEnVivo(0)
print("Smart Gym - Módulo de Elevaciones Laterales iniciado. Presiona 'ESC' para salir.")
 
speaker.speak_unique("Prepárate, de frente a la cámara")
...
while cap.isOpened():
    ...
    cv2.imshow('Smart Gym - Elevaciones Laterales en Vivo', image)
