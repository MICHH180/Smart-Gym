...
sesion_id = registro.iniciar_sesion("curl_biceps")
 
cap = CamaraEnVivo(0)
print("Smart Gym - Módulo de Curl de Bíceps iniciado. Presiona 'ESC' para salir.")
...
while cap.isOpened():
    ...
    cv2.imshow('Smart Gym - Curl de Biceps en Vivo', image)
