...
#         # model_complexity=0 es el modelo más liviano de MediaPipe. Es el que menos
#         # tarda por frame, lo cual ayuda a que la cámara no se vaya atrasando.
#         # Si tu equipo es potente y quieres más precisión, puedes subirlo a 1.
...
class PoseDetector:
    def __init__(self, min_detection_confidence=0.65, min_tracking_confidence=0.65, model_complexity=0):
        self.mp_drawing = mp.solutions.drawing_utils
        self.mp_pose = mp.solutions.pose
        # model_complexity=0 es el modelo más liviano de MediaPipe. Es el que menos
        # tarda por frame, lo cual ayuda a que la cámara no se vaya atrasando.
